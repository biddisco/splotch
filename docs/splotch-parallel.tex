...
content, appropirate tools are needed. Visual data
...
can compromise significantly overall execution times (see Table 2).
...
then $y$ coordinates and so on) as expected by the MPI-IO based reader.
...
when there is a large display calculation involved, that is when individual particles i
nfluence relatively large areas on the screen. This is indeed the case for typical 
