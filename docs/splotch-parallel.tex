...
are limited either 
on processing and displaying of 2D images (see e.g. \cite{iraf}, 
\cite{midas}, \cite{sao},
\cite{gaia}) or on
...
of large-scale astrophysical datasets (e.g. \cite{paraview}, \cite{aladin}, 
...
shared datasets) and collaborative workflows (permitting several users to 
...
other works about the visualization of its datasets, the reader 
...
We used several benchmark datasets for our testing. The first 
...
We would like to thank Mike Boylan-Kolchin for providing the MilleniumII simulation datasets 
...
\bibitem{visivo1}M. Comparato, U. Becciani, A. Costa, B. Garilli, C. Gheller, B. Larsson and J. Taylor, Visualization, Exploration and Data Analysis of Complex Astrophysical Data,  The Publications of the Astronomical Society of the Pacific, Volume 119, Issue 858, pp. 898-913, 2007.
...
\bibitem{visivo2}U. Becciani, A. Costa, V. Antonnuccio-Delogu, G. Caniglia, M. Comparato, C, Gheller, Z. Jin, M. Krokos, P. Massimino, VisIVO-Integrated Tools and Services for Large-Scale Astrophysical Visualization, The Publications of the Astronomical Society of the Pacific, (to appear).

\bibitem{2008NJPh...10l5006D}K.Dolag, M. Reinecke, C.Gheller, S. Imboden, Splotch: Visualizing Cosmological Simulations, New Journal of Physics, Volume 10, Issue 12, pp. 125006, 2008.
...
\bibitem{1985A&A...149..135M} J. Monaghan and J. Lattanzio, A Refined Particle Method for Astrophysical Problems, A\&A, 149, 135, 1985
