...
\bibitem{splotch} Splotch original reference

\bibitem{splotchmulti} Multinode multicore reference

\bibitem{splotchgpu} Cuda paper reference
...
\bibitem{gadget} Gadget Reference
